...
const target = `import Dashboard from './components/RoleDashboards';`;
const replacement = `import Dashboard from './components/RoleDashboards';
...
console.log('App.tsx has been restored successfully!');
