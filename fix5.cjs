...
const startTag = '<aside className="w-64 border-r border-slate-200 bg-white flex flex-col justify-between shrink-0">';
const endTag = '</aside>';
...
if (startIndex !== -1 && endIndex !== -1) {
    ...
    console.log('Successfully repaired aside element.');
} else {
    console.error('Could not find aside tags.');
}
